...
SELECT        TOP (100) PERCENT cass.t_j_История_загрузки_смен_на_кассе.Код_события, cass.t_j_История_загрузки_смен_на_кассе.ИД_обмена, cass.t_j_История_загрузки_смен_на_кассе.Код_кассы, 
                         ...
                         cass.t_j_История_загрузки_смен_на_кассе.Дата_время_окончания_загрузки) AS [Время загрузки в мс], cass.t_fact_Смены_на_кассах.Код_кассира, cass.t_fact_Смены_на_кассах.Дата_время_начала_смены, 
...
FROM            cass.t_j_История_загрузки_смен_на_кассе INNER JOIN
                         ...
                         cass.t_fact_Смены_на_кассах WITH (nolock) ON cass.t_j_История_загрузки_смен_на_кассе.Код_кассы = cass.t_fact_Смены_на_кассах.Код_кассы AND 
                         cass.t_j_История_загрузки_смен_на_кассе.ИД_смены = cass.t_fact_Смены_на_кассах.ИД_Смены
