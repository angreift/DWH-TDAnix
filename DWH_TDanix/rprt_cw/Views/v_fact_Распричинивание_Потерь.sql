...
SELECT        rprt_cw.t_fact_Распричинивание_потерь.Дата, dbo.t_dim_Магазины.Код AS Код_магазина, dbo.t_dim_Магазины.Наименование AS Магазин,  dbo.t_dim_Товары.Код_товара,  dbo.t_dim_Товары.Наименование AS Товар, 
						 rprt_cw.t_fact_Факты_потерь.Сумма, rprt_cw.t_fact_Факты_потерь.Количество, 
                         rprt_cw.t_dim_Причины_потерь.Причина, rprt_cw.t_dim_Причины_потерь.Подпричина,
...
FROM            rprt_cw.t_fact_Распричинивание_потерь INNER JOIN
                         ...
                         rprt_cw.t_fact_Распричинивание_потерь.Код_магазина = rprt_cw.t_fact_Факты_потерь.Код_магазина AND rprt_cw.t_fact_Распричинивание_потерь.Код_товара = rprt_cw.t_fact_Факты_потерь.Код_товара
GO