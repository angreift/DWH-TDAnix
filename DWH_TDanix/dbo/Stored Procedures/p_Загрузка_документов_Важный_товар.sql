...
AS BEGIN
	...
	update #t_raw_Важный_товар set [Код_сценария] = (Select [Код_сценария] from dbo.t_dim_Сценарии_важного_товара 
													where dbo.t_dim_Сценарии_важного_товара.Сценарий_важного_товара = #t_raw_Важный_товар.Сценарий) 
