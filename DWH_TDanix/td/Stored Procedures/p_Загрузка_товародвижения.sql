...
BEGIN
	...
	begin try
		...
		insert into [td].t_fact_Товародвижение (
			...
			[Дата], [Код_магазина], (select Код_склада from [td].t_dim_Склад_в_магазине where Наименование_склада = [Склад]), 5, [КодТовара], [Сумма], [СуммаЗакупа], 
			[СуммаЗакупаСоСклада], [Цена], [ЦенаЗакупа], [ЦенаЗакупаСоСклада], [Количество], [Код_причины]
		from
	...
	begin try
		...
		insert into [td].t_fact_Товародвижение (
			...
			cast([Код_магазина] as nvarchar) + '[ВП]' + cast([Номер] as nvarchar),
			[Дата], [Код_магазина], (select Код_склада from [td].t_dim_Склад_в_магазине where Наименование_склада = [Склад]), 6, [КодТовара], [Сумма], [СуммаЗакупа], 
			[СуммаЗакупаСоСклада], [Цена], [ЦенаЗакупа], [ЦенаЗакупаСоСклада], [Количество], [Код_причины]
		from
	...
	begin try
		...
		insert into [td].t_fact_Товародвижение (
			...
			[Дата], [Код_магазина], (select Код_склада from [td].t_dim_Склад_в_магазине where Наименование_склада = [Склад]), 7, [КодТовара], [Сумма], [СуммаЗакупа], 
			[СуммаЗакупаСоСклада], [Цена], [ЦенаЗакупа], [ЦенаЗакупаСоСклада], [Количество], [Код_причины]
		from
	...
	begin try
		...
		insert into [td].t_fact_Товародвижение (
			...
			[Дата], [Код_магазина], (select Код_склада from [td].t_dim_Склад_в_магазине where Наименование_склада = [Склад]), 8, [КодТовара], [Сумма], [СуммаЗакупа], 
			[СуммаЗакупаСоСклада], [Цена], [ЦенаЗакупа], [ЦенаЗакупаСоСклада], [Количество], [Код_причины]
		from
	...
	begin try
		...
		insert into [td].t_fact_Товародвижение (
			...
			[Дата], [Код_магазина], (select Код_склада from [td].t_dim_Склад_в_магазине where Наименование_склада = [Склад]), 9, [КодТовара], [Сумма], [СуммаЗакупа], 
			[СуммаЗакупаСоСклада], [Цена], [ЦенаЗакупа], [ЦенаЗакупаСоСклада], [Количество], [Код_причины]
		from
	...
	begin try
		...
		insert into [td].t_fact_Товародвижение (
			...
			[Дата], [Код_магазина], (select Код_склада from [td].t_dim_Склад_в_магазине where Наименование_склада = [Склад]), 10, [КодТовара], [Сумма], [СуммаЗакупа], 
			[СуммаЗакупаСоСклада], [Цена], [ЦенаЗакупа], [ЦенаЗакупаСоСклада], [Количество], [Код_причины]
		from
