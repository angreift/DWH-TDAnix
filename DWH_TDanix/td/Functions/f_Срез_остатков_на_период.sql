...
RETURNS @Result TABLE (Дата date, Код_магазина int, Код_склада_в_магазине int, Код_товара bigint, 
		...
		Остаток_на_начало_дня decimal(14,3), Поставщик_холдинга nvarchar(100), Важный_товар bit)
AS
BEGIN
	...
	While @Дата <= @Дата_кон Begin
		...
		Select 
			...
			Сумма_на_начало_дня, Сумма_закупа_на_начало_дня, Сумма_закупа_со_склада_на_начало_дня, Остаток_на_начало_дня, Поставщик_холдинга, Важный_товар
		from 
