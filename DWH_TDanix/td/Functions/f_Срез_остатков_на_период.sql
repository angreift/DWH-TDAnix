...
RETURNS @Result TABLE (Дата date, Код_магазина int, Код_склада_в_магазине int, Код_товара bigint, 
		...
		Остаток_на_начало_дня decimal(14,3), Поставщик_холдинга nvarchar(100), Важный_товар bit, Сценарий_важного_товара nvarchar(64))
AS
BEGIN
	...
	While @Дата <= @Дата_кон Begin
		...
		Select 
			...
			Поставщик_холдинга, Важный_товар, Сценарий_важного_товара
		from 
