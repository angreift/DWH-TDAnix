CREATE TABLE [cass].[t_raw_Позиции_документа] (
    ...
    CONSTRAINT [PK_t_raw_Позиции_документа] PRIMARY KEY CLUSTERED ([ИД_позиции] ASC) ON [RAW]
) ON [RAW];


GO
CREATE NONCLUSTERED INDEX [ix_uncl_ИД_документа]
    ON [cass].[t_raw_Позиции_документа]([ИД_документа] ASC)
    ON [RAW];
