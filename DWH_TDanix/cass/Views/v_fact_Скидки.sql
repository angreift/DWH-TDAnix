...
FROM            cass.t_fact_Скидки INNER JOIN
                         ...
                         td.v_fact_Товарная_матрица with (nolock) ON cass.t_fact_Скидки.Дата_применения_скидки = td.v_fact_Товарная_матрица.Дата AND cass.t_fact_Скидки.Код_товара = td.v_fact_Товарная_матрица.Код_товара AND 
