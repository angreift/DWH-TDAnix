...
AS
SELECT        cass.t_fact_Смены_на_кассах.Код_кассы, cass.t_fact_Смены_на_кассах.Номер_смены,
                         ...
                         cass.t_fact_Смены_на_кассах.Количество_чеков_возврата, cass.t_fact_Смены_на_кассах.Составной_код_Смены, 
                         cass.t_fact_Смены_на_кассах.Составной_код_кассира, dbo.t_dim_Магазины.Код, 
                         ...
                         ,null as Код_кассира, null as ИД_смены
