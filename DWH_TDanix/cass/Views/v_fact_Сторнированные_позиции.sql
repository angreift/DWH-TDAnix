...
AS
SELECT        cass.t_fact_Сторнированные_позиции.ИД_сторнированной_позиции, 
                         ...
                         cass.t_fact_Сторнированные_позиции.Итоговая_сумма_после_применения_скидок, cass.t_fact_Сторнированные_позиции.Номер_сторнированной_позиции, 
                         cass.t_fact_Сторнированные_позиции.Составной_код_кассира_подтвердившего_сторно, CAST(CAST(cass.t_fact_Сторнированные_позиции.Дата_время_сторнирования_позиции AS date) AS datetime) 
                         AS Дата_сторнирования_позиции, cass.t_fact_Сторнированные_позиции.Составной_код_кассира, 
                          cass.v_dim_Кассы.Код_магазина, cass.t_fact_Сторнированные_позиции.Составной_код_документа, dbo.t_dim_Товары.Код_товара, 
                         cass.t_fact_Сторнированные_позиции.Код_кассы,
                         null as Код_кассира,
                         null as ИД_документа,
                         null as Пользователь_подтвердивший_операцию,
                         null as Составной_код_пользователя_подтвердившего_сторно,
                         null as Составной_код_пользователя_подтвердившего_операцию
