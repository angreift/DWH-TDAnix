...
SELECT        cass.t_fact_Сторнированные_позиции.ИД_сторнированной_позиции, cass.t_fact_Сторнированные_позиции.Дата_время_добавления_сторнированной_позиции, 
                         ...
                         COALESCE
                             ((SELECT        TOP (1) Признак
                                 ...
                                 WHERE        (Дата <= cass.t_fact_Сторнированные_позиции.[Дата_сторнирования_позиции]) AND (Код_товара = cass.t_fact_Сторнированные_позиции.Код_товара) AND (Код_магазина = cass.v_dim_Кассы.Код_магазина)), 0) 
                         AS Признак,
