...
FROM            cass.t_fact_Сторнированные_позиции INNER JOIN
                         cass.v_dim_Кассы ON cass.t_fact_Сторнированные_позиции.Код_кассы = cass.v_dim_Кассы.Код_кассы INNER JOIN
                         td.v_fact_Товарная_матрица ON cass.t_fact_Сторнированные_позиции.Код_товара = td.v_fact_Товарная_матрица.Код_товара AND 
                         cass.v_dim_Кассы.Код_кассы = td.v_fact_Товарная_матрица.Код_магазина LEFT OUTER JOIN
