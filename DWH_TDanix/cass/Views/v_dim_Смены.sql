...
SELECT        с.Код_кассы, с.Номер_смены, с.Составной_код_смены, dbo.t_dim_Магазины.Группа, 
                         ...
                         null as Код_кассира,
                         null as ИД_смены
FROM cass.t_fact_Смены_на_кассах AS с            
                        left JOIN
                         cass.v_dim_Пользователи_на_кассах ON cass.v_dim_Пользователи_на_кассах.Составной_код_кассира = с.Составной_код_кассира LEFT OUTER JOIN
